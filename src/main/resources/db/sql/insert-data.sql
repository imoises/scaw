...
INSERT INTO USUARIO(NICKNAME, NOMBRE, APELLIDO, EMAIL, PASSWORD, ROL, ESTADO  ) VALUES  ('root','','','','','bloqueado','bloqueado');
-- la pass para user1 es 123 
INSERT INTO USUARIO(NICKNAME, NOMBRE, APELLIDO, EMAIL, PASSWORD, ROL, ESTADO  ) VALUES  ('admin','','','','','bloqueado','bloqueado');
-- la pass para user1 es 123 
INSERT INTO USUARIO(NICKNAME, NOMBRE, APELLIDO, EMAIL, PASSWORD, ROL, ESTADO  ) VALUES  ('sa','','','','','bloqueado','bloqueado');
-- la pass para user1 es 123 
